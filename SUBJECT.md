...
The @everyone - send messages must be set to false
The @Member role must be create - send message set to true
When call !mute is called -> remove all role
When !mute is re-call -> give Admin role
